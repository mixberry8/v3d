...
static constexpr wchar_t* Log_Error_MismatchRAContainerAttachmentCount = L"IV3DDevice::CreateFrameBuffer : 指定されたレンダーパスと作成しようとしているレンダーアタッチメントコンテナのアタッチメントの数が一致しません。";
...
static constexpr wchar_t* Log_Error_NotVertexBufferViews = L"IV3DCommandBuffer::BindVertexBufferViews : バインディング %u はバーテックスバッファビューではありません。";
